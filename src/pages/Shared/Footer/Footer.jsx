        ...
        <footer className="bg-white shadow-md dark:bg-gray-900">
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                <div className="md:flex md:justify-between">
                    <div className="mb-6 md:mb-0">
                        <Link to='/' className="flex items-center">
                            <img src={logo} className="h-22" alt="FlowBite Logo" />
                            
                        </Link>
                    </div>
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        <div>
                            <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Reaching Cars</h2>
                        ...
                        <div>
                            ...
                            <ul className="text-gray-600 dark:text-gray-400 font-medium">
                                <li className="mb-4">
                                    <Link to="https://github.com/roushanali064" className="hover:underline ">Github</Link>
                                </li>
                                <li>
                                    <Link to="https://web.facebook.com/roushanali.r/" className="hover:underline">FaceBook</Link>
                                </li>
                            </ul>
                        </div>
                        <div>
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <Link  className="hover:underline">Kids-Life™</Link>. All Rights Reserved.
                    </span>
                    <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                        <Link to="https://web.facebook.com/roushanali.r/" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
